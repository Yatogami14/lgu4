                ...
                <div class="bg-gradient-to-r from-brand-500 to-brand-600 rounded-2xl shadow-lg p-8 text-white relative overflow-hidden">
                    ...
                    <div class="flex justify-between items-start gap-4">
                        <div class="flex-grow">
                            ...
                            <p class="text-brand-100 mt-2 relative z-10">Here's what's happening in the inspection platform in the last <?php echo $date_range; ?> days.</p>
                        </div>
                        <div class="flex-shrink-0">
                            <div class="bg-white/20 backdrop-blur-sm p-2 rounded-xl shadow-sm border border-white/30">
                                <select id="dateRangeFilter" class="border-none text-sm font-medium text-white focus:ring-0 cursor-pointer bg-transparent">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
                        <a href="businesses.php" class="group bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="h-12 w-12 bg-brand-50 rounded-full flex items-center justify-center text-brand-600 group-hover:bg-brand-100 transition-colors">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                                ...
                                <div class="relative text-gray-900">
                                    <input type="text" id="upcomingInspectionsSearch" placeholder="Search..." class="pl-9 pr-3 py-1.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent bg-white">
                                    ...
                                    <?php if (!empty($upcomingInspections)): ?>
                                        ...
                                        <li class="p-4 hover:bg-gray-50 transition-colors flex justify-between items-center" data-search-term="<?php echo htmlspecialchars(strtolower($inspection['business_name'] . ' ' . $inspection['inspection_type'])); ?>">
                                            ...
                                            <div class="text-right">
                                                ...
                                                <a href="inspection_view.php?id=<?php echo $inspection['id']; ?>" class="text-xs text-brand-600 hover:text-brand-700 font-medium">View Details</a>
                                            </div>
                                        </li>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        ...
                                        <li class="p-4 hover:bg-gray-50 transition-colors flex justify-between items-center">
                                            ...
                                            <div class="text-right">
                                                ...
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                    <?php echo $inspection['status'] == 'completed' ? 'bg-green-100 text-green-800' : 'bg-brand-100 text-brand-800'; ?>">
                        ...
                        <?php if (!empty($communityReports)): ?>
                            ...
                            <li class="p-4 hover:bg-gray-50 transition-colors flex justify-between items-center">
                                ...
                                <div class="text-right ml-4 flex-shrink-0">
                                    ...
                                    <a href="violations.php" class="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-brand-700 bg-brand-100 hover:bg-brand-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500">
                                        Create Inspection
                                    </a>
                                </div>
                            </li>
