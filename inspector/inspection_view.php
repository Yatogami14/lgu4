...
if ($inspection_id <= 0) {
    header('Location: assigned_inspections.php?error=Invalid ID');
    exit;
}
...
if (!$inspection_data) {
    header('Location: assigned_inspections.php?error=Inspection not found');
    exit;
}
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 md:ml-64 md:pt-20">
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0 mb-6">
            ...
            <div class="flex items-center space-x-2">
                <a href="assigned_inspections.php" class="bg-white border border-gray-300 px-4 py-2 rounded-md hover:bg-gray-50 text-sm">
                    <i class="fas fa-arrow-left mr-2"></i>Back to My Assignments
                </a>
