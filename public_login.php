...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user->login()) {
        ...
        if ($user->role == 'business_owner') {
            ...
            header('Location: index.php'); // Community users go to main page
        }
        exit;
    } else {
...
<body class="font-sans">
    <div class="login-card p-8 w-full max-w-md mx-4">
        ...
        <div class="mt-4 text-center">
            <p class="text-sm text-gray-600">Are you an inspector or administrator? 
                <a href="admin_login.php" class="text-blue-600 hover:text-blue-800 font-medium">Admin Login</a>
            </p>
        </div>
