    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 md:ml-64 md:pt-24">
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0 mb-6">
            <div>
                ...
                <p class="text-gray-600">Public Analysis for <span class="font-medium"><?php echo htmlspecialchars($inspection_data['business_name']); ?></span></p>
            </div>
                    ...
                    ?>
                        <div class="border rounded-lg overflow-hidden">
                            <div class="bg-gray-200 flex items-center justify-center h-48">
                                <img src="../uploads/<?php echo htmlspecialchars($media['file_path']); ?>" alt="<?php echo htmlspecialchars($media['file_name']); ?>" class="max-h-full max-w-full object-contain">
                            </div>
                            <div class="p-4">
                                <p class="text-xs text-gray-500 truncate mb-3" title="<?php echo htmlspecialchars($media['file_name']); ?>"><?php echo htmlspecialchars($media['file_name']); ?></p>
