...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $user->department = null; // No department for business owners
    $user->certification = 'Business Owner'; // Automatically set certification
    ...
    if ($user->emailExists()) {
        ...
        if ($user->create()) {
            $success_message = "Business account created successfully! You can now login.";
        } else {
...
<head>
    ...
    <title>Business Registration - Digital Health & Safety Inspection Platform</title>
