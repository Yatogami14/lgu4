...
$business_list = $business->readByOwnerId($_SESSION['user_id']);

$total_businesses = count($business_list);
$high_risk = 0;
$medium_risk = 0;
$low_risk = 0;

foreach($business_list as $b) {
    if ($b['compliance_score'] < 50) $high_risk++;
    elseif ($b['compliance_score'] < 80) $medium_risk++;
    else $low_risk++;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>My Businesses - Digital Health & Safety Inspection Platform</title>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold"><?php echo $high_risk; ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold"><?php echo $medium_risk; ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold"><?php echo $low_risk; ?></p>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php foreach ($business_list as $business_row): ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                <?php $stats = $business->getComplianceStats($business_row['id']); ?>
                                <div class="w-16 bg-gray-200 rounded-full h-2">
                                    <div class="bg-green-600 h-2 rounded-full" style="width: <?php echo $stats['avg_compliance'] ?? 0; ?>%"></div>
                                </div>
                                <span class="text-sm font-medium"><?php echo $stats['avg_compliance'] ?? 0; ?>%</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php 
